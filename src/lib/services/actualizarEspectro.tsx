...
import connectToDatabase from '../db/mongodb'; // Asegúrate de que la ruta sea correcta según tu estructura de archivos
import Ingrediente from '../db/models/Ingrediente'; // Asegúrate de que la ruta sea correcta según tu estructura de archivos
